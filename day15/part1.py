...
# Idea: For each point, there exists one cheapest path cost.
# Start from the destination and work backwards.
# Cheapest path from a point is the cheapest cost of its neighbours.
# Cost of all neighbours can't be known, so make sure that the cheapest is known first.
# Prioritize by anticipated cost.
